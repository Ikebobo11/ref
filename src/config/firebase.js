...
/** Cloud Firestore instance (standard initialization to avoid persistentLocalCache bugs) */
...
/**
 * Firebase Cloud Messaging instance (async - may not be supported in all environments).
 * Resolves to a Messaging instance or null. Await this before use.
 */
