...
export const logUpgradeReject = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'upgrade.reject', actorId, actorRole, targetId, targetType: 'upgrade', details });

export const logAccountChangeApprove = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'account_change.approve', actorId, actorRole, targetId, targetType: 'account_change', details });

export const logAccountChangeReject = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'account_change.reject', actorId, actorRole, targetId, targetType: 'account_change', details });

export const logAdminInvite = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'admin.invite', actorId, actorRole, targetId, targetType: 'admin', details });

export const logAdminRemove = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'admin.remove', actorId, actorRole, targetId, targetType: 'admin', details });

export const logSettingsUpdate = (actorId, actorRole, details = {}) =>
  logAudit({ action: 'settings.update', actorId, actorRole, details });

export const logPaymentProcessed = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'payment.processed', actorId, actorRole, targetId, targetType: 'payment', details });

export const logWithdrawalProcess = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'withdrawal.process', actorId, actorRole, targetId, targetType: 'withdrawal', details });

export const logWithdrawalComplete = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'withdrawal.complete', actorId, actorRole, targetId, targetType: 'withdrawal', details });

export const logWithdrawalFail = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'withdrawal.fail', actorId, actorRole, targetId, targetType: 'withdrawal', details });

export const logDisputeResolve = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'dispute.resolve', actorId, actorRole, targetId, targetType: 'dispute', details });

export const logDisputeReject = (actorId, actorRole, targetId, details = {}) =>
  logAudit({ action: 'dispute.reject', actorId, actorRole, targetId, targetType: 'dispute', details });
