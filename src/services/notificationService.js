...
export const notifyWithdrawalCompleted = (uid, amount) =>
  createNotification({
    uid,
    type: NOTIFICATION_TYPES.WITHDRAWAL_SUCCESSFUL,
    title: 'Withdrawal Completed',
    message: `Your withdrawal of ₦${amount?.toLocaleString?.() || amount} has been processed successfully.`,
    link: '/earner/wallet',
  });

export const notifyWithdrawalFailed = (uid, amount, reason) =>
  createNotification({
    uid,
    type: NOTIFICATION_TYPES.WITHDRAWAL_SUCCESSFUL,
    title: 'Withdrawal Failed',
    message: `Your withdrawal of ₦${amount?.toLocaleString?.() || amount} failed.${reason ? ` Reason: ${reason}` : ''}`,
    link: '/earner/wallet',
  });

export const notifyDisputeResolved = (uid, resolution) =>
  createNotification({
    uid,
    type: NOTIFICATION_TYPES.ADMIN_MESSAGE,
    title: 'Dispute Resolved',
    message: `Your dispute has been resolved.${resolution ? ` Resolution: ${resolution}` : ''}`,
    link: '/earner/dashboard',
  });

export const notifyDisputeRejected = (uid) =>
  createNotification({
    uid,
    type: NOTIFICATION_TYPES.ADMIN_MESSAGE,
    title: 'Dispute Rejected',
    message: 'Your dispute was reviewed and rejected.',
    link: '/earner/dashboard',
  });
