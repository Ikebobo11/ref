...
import { FaUserShield, FaCircleCheck, FaCircleXmark, FaArrowUpRightFromSquare } from 'react-icons/fa6';
...
export default function VerificationQueue() {
  ...
  const handleApprove = async (request) => {
    ...
    try {
      await approveVerification(request.id, userData.uid, userData?.role || 'admin');
  ...
  const handleReject = async () => {
    ...
    try {
      await rejectVerification(rejectModal.id, userData.uid, userData?.role || 'admin', rejectReason);
                  ...
                  <div className="review-detail-row">
                    ...
                    <span className="value">
                      <a href={request.profileUrl} target="_blank" rel="noopener noreferrer">
                        <FaArrowUpRightFromSquare /> View profile
                      </a>
                    </span>
                  </div>
                  <div className="review-detail-row">
                    ...
                    <span className="value">
                      <a href={request.followerScreenshotUrl} target="_blank" rel="noopener noreferrer">
                        <FaArrowUpRightFromSquare /> View screenshot
                      </a>
                    </span>
                  </div>
                  <div className="review-detail-row">
      ...
      >
        <div className="reject-form">
          <p className="reject-info">
            Rejecting this verification means the followers are fake, bought, artificial, bot, or
            spam. The <strong>₦1,000 fee is non-refundable</strong>.
          </p>
          <Input
