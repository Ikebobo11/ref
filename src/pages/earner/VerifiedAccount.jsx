...
import { FaShieldHalved, FaArrowRightArrowLeft, FaArrowUpRightDots, FaArrowUpRightFromSquare } from 'react-icons/fa6';
      ...
      <Card className="verified-account-card">
        ...
        <CardBody>
            ...
            <div className="verified-account-hero-info">
              ...
              {userData?.profileUrl && (
                <a href={userData.profileUrl} target="_blank" rel="noopener noreferrer" className="profile-link">
                  <FaArrowUpRightFromSquare /> {userData.profileUrl}
                </a>
              )}
            </div>
          </div>
          ...
          <div className="verified-account-details-grid">
            ...
            <div className="verified-account-detail-item">
              <span className="label">Last Verification Date</span>
              <span className="value">
                {userData?.lastVerificationDate
                  ? formatDate(userData.lastVerificationDate?.toDate?.() || userData.lastVerificationDate)
                  : 'Not yet verified'}
              </span>
            </div>
          </div>

          <div className="verified-account-policy">
            <h4>Important Policy</h4>
            <p>
              You must complete every task using this exact verified account. Using a different
              account or platform may result in task rejection, account suspension, or permanent
              banning from LETCON.
            </p>
          </div>

          <div className="verified-account-actions">
            <Link to="/earner/account-change">
              <Button variant="outline">
                <FaArrowRightArrowLeft /> Request Account Change
              </Button>
            </Link>
            <Link to="/earner/upgrade">
              <Button variant="outline">
