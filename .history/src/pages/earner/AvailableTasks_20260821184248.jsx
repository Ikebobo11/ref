    ...
    <div className="dashboard-page">
      ...
      {availableTasks.length === 0 ? (
        <EmptyState
          ...
          message={
            tasks.length > 0
              ? 'You have accepted all available tasks. Check the Accepted Tasks section to submit your proofs.'
              : `There are currently no ${tier} ${platform} tasks available. New tasks appear here when advertisers publish them.`
          }
        />
      ) : (
      ...
      >
        {selectedTask && (
          <div className="task-detail-modal">
            ...
            <div className="task-detail-meta"></div>
