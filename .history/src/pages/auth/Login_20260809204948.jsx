...
export default function Login() {
  ...
  // If the user is already signed in, redirect them to their dashboard.
  useEffect(() => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (route) {
        ...
        toast.error(
          'We could not load your account details. Please check your connection and try again, or contact support.'
        );
      }
    } catch (error) {
