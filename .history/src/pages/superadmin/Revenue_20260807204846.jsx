  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="stat-grid">
        ...
        <StatCard icon={<FaArrowUpRightDots />} label="Posting Fees" value={formatNaira(postingFees)} color="warning" />
      </div>

      <div className="stat-grid">
        <StatCard icon={<FaWallet />} label="Earner Payments (70%)" value={formatNaira(earnerPayments)} color="success" />
        <StatCard icon={<FaWallet />} label="Total Transactions" value={formatNumber(transactions.length)} color="info" />
      </div>
        ...
        <CardBody>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={revenueByType}>
              ...
              <Legend />
              <Bar dataKey="value" fill="#6c5ce7" name="Amount" />
            </BarChart>
          </ResponsiveContainer>
