...
export default function AdminChat() {
  ...
  const { data: admins, loading } = useFirestoreQuery(COLLECTIONS.USERS, {
    filters: [{ field: 'role', operator: '==', value: ROLES.ADMIN }],
    limitCount: 50,
  });
      ...
      <div className="chat-layout">
        ...
        <Card className="chat-main">
          ...
          <CardBody className="chat-main-body">
            {!selectedConv ? (
              <EmptyState icon={<FaCommentDots />} title="No conversation selected" message="Select an admin from the left to start chatting." />
            ) : (
