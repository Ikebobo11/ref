              ...
              <CardBody>
                <div className="review-item-header">
                  ...
                  <span className="review-item-time">
                    {formatDateTime(dispute.createdAt?.toDate?.() || dispute.createdAt)}
                  </span>
                </div>
                <div className="review-item-details">
                  <div className="review-detail-row">
                    <span className="label">User</span>
                    <span className="value">{dispute.uid || 'N/A'}</span>
                  </div>
                  <div className="review-detail-row">
                    <span className="label">Type</span>
                    <span className="value">{dispute.type || 'General'}</span>
                  </div>
                  <div className="review-detail-row">
                    <span className="label">Message</span>
                    <span className="value">{dispute.message || dispute.description || 'N/A'}</span>
                  </div>
                  {dispute.taskId && (
                    <div className="review-detail-row">
                      <span className="label">Task</span>
                      <span className="value">{dispute.taskId}</span>
                    </div>
                  )}
                </div>
