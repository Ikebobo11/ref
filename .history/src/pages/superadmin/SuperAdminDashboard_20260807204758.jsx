  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="dashboard-grid">
        ...
        <Card className="dashboard-section">
          <CardHeader>
            ...
            <Link to="/super-admin/withdrawals" className="text-link">View all</Link>
          </CardHeader>
          <CardBody>
            {withdrawals.length === 0 ? (
              <EmptyState icon={<FaArrowUpRightDots />} title="No pending withdrawals" />
            ) : (
              <div className="task-list">
                {withdrawals.map((wd) => (
                  <div key={wd.id} className="task-list-item">
                    <div className="task-list-item-top">
                      <h4 className="task-list-item-title">{formatNaira(wd.amount)}</h4>
                      <Badge variant="warning">Pending</Badge>
                    </div>
                    <div className="task-list-item-meta">
      ...
      <div className="quick-actions">
        <Link to="/super-admin/revenue" className="quick-action-btn">
          <FaWallet /> View Revenue
        </Link>
        <Link to="/super-admin/admins" className="quick-action-btn">
          <FaUserShield /> Manage Admins
        </Link>
        <Link to="/super-admin/audit-logs" className="quick-action-btn">
          <FaScroll /> Audit Logs
        </Link>
      </div>
    </div>
