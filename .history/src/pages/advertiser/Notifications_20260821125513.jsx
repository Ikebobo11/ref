        ...
        <CardBody>
          {notifications.length === 0 ? (
            <EmptyState
              ...
              message="You will be notified about task submissions and campaign updates."
            />
          ) : (
      ...
      >
        <div className="reject-form">
          <p className="reject-info">
            Are you sure you want to delete all {notifications.length} notifications? This action
            cannot be undone.
          </p>
          <Button
            variant="danger"
            ...
            loading={deletingAll}
          >
            <FaTrashCan /> Delete All Notifications
          </Button>
        </div>
      </Modal>
    </div>
