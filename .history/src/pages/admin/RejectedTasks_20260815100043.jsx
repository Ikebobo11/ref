...
import { FaCircleXmark, FaCircleCheck, FaArrowUpRightFromSquare } from 'react-icons/fa6';
...
export default function RejectedTasks() {
  ...
  const handleReject = async () => {
    ...
    try {
      await rejectTaskSubmission(rejectModal.id, userData.uid, rejectReason.trim(), 'admin');
  ...
  return (
    <div className="dashboard-page">
            ...
            <Card key={submission.id} className="review-item">
              <CardBody>
                ...
                <div className="review-item-details">
                    ...
                    <div className="review-detail-row">
                      ...
                      <span className="value">
                        <a href={submission.postLink} target="_blank" rel="noopener noreferrer">
                          <FaArrowUpRightFromSquare /> View post
                        </a>
                      </span>
                    </div>
                  )}
                  {submission.notes && (
                    <div className="review-detail-row">
                      <span className="label">Earner Notes</span>
      ...
      <Modal
        ...
        title="Reject Task (Final Decision)"
      >
        <div className="reject-form">
          <p className="reject-info">
            This is the <strong>final decision</strong>. The earner will be notified and no
            payment will be released.
          </p>
          <Input
            label="Rejection Reason (Required)"
            type="text"
            placeholder="Final rejection reason - this will be shown to the earner"
            value={rejectReason}
          ...
          >
            <FaCircleXmark /> Confirm Final Rejection
          </Button>
        </div>
      </Modal>
    </div>
