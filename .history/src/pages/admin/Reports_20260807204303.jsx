...
export default function Reports() {
  ...
  const verifiedEarners = users.filter((u) => u.role === 'earner' && u.verified).length;
  const totalEarners = users.filter((u) => u.role === 'earner').length;
  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="stat-grid">
        ...
        <StatCard icon={<FaWallet />} label="Platform Revenue" value={formatNaira(totalRevenue)} color="warning" />
      </div>
