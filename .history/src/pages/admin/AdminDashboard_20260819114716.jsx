...
export default function AdminDashboard() {
  ...
  const { data: rejectedTasks, loading: rejectedLoading } = useFirestoreQuery(COLLECTIONS.TASK_SUBMISSIONS, {
  ...
  const { data: flagged, loading: flaggedLoading } = useFirestoreQuery(COLLECTIONS.TASK_SUBMISSIONS, {
