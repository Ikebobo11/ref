...
import { FaTriangleExclamation, FaCircleCheck, FaCircleXmark, FaArrowUpRightFromSquare } from 'react-icons/fa6';
...
export default function FlaggedMismatches() {
  ...
  const { data: submissions, loading } = useFirestoreQuery(COLLECTIONS.TASK_SUBMISSIONS, {
  ...
  return (
    <div className="dashboard-page">
            ...
            <Card key={submission.id} className="review-item flagged">
              <CardBody>
                ...
                <div className="review-item-details">
                  ...
                  <div className="review-detail-row">
                    <span className="label">Mismatch Reason</span>
                    <span className="value danger-text">{submission.matchReason}</span>
                  </div>
                  {submission.postLink && (
                    <div className="review-detail-row">
      ...
      <Modal
        ...
        title="Reject Flagged Submission"
      >
        <div className="reject-form">
          <p className="reject-info">
            Rejecting this submission records a <strong>verified account violation</strong>.
