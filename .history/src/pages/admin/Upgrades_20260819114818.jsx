...
import { FaArrowUpRightDots, FaCircleCheck, FaCircleXmark, FaArrowUpRightFromSquare } from 'react-icons/fa6';
...
export default function Upgrades() {
  ...
  const handleApprove = async (request) => {
    ...
    try {
      await approveUpgrade(request.id, userData.uid, userData?.role || 'admin');
  ...
  const handleReject = async () => {
    ...
    try {
      await rejectUpgrade(rejectModal.id, userData.uid, userData?.role || 'admin', rejectReason);
      ...
      >
        <div className="reject-form">
          <Input
            ...
            type="text"
            placeholder="Why is this upgrade being rejected?"
            value={rejectReason}
