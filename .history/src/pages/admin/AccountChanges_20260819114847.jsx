...
import { FaArrowRightArrowLeft, FaCircleCheck, FaCircleXmark, FaArrowUpRightFromSquare } from 'react-icons/fa6';
...
export default function AccountChanges() {
  ...
  const handleApprove = async (request) => {
    ...
    try {
      await approveAccountChange(request.id, userData.uid, userData?.role || 'admin');
  ...
  const handleReject = async () => {
    ...
    try {
      await rejectAccountChange(rejectModal.id, userData.uid, userData?.role || 'admin', rejectReason);
