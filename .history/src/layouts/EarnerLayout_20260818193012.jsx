...
const NAV_ITEMS = [
  ...
  { to: '/earner/messages', label: 'Messages', icon: <FaCommentDots /> },
  { to: '/earner/notifications', label: 'Notifications', icon: <FaBell /> },
  { to: '/earner/transactions', label: 'Transactions', icon: <FaArrowRightFromBracket /> },
];
 * EarnerLayout component.
 */
export default function EarnerLayout() {
  return (
    <DashboardLayout navItems={NAV_ITEMS} title="Earner Dashboard">
