...
import SuperAdminChat from './pages/admin/SuperAdminChat';
...
export default function App() {
  return (
    <Routes>
      ...
      {/* Earner Routes (guarded: earner only) */}
      <Route element={<ProtectedRoute allowedRoles={[ROLES.EARNER]} />}>
      ...
      {/* Advertiser Routes (guarded: advertiser only) */}
      <Route element={<ProtectedRoute allowedRoles={[ROLES.ADVERTISER]} />}>
